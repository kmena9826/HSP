...
namespace CS_HOSPITALARIO.Controllers
{
    ...
    public class LoginController : Controller
    {
        ...
        public ActionResult Acceso ([Bind(Include = "USERNAME, CLAVE")] CS_USER usuario)
        {
            ...
            {
                TempData["Message"] = "Su usuario se encuentra en estado inactivo";
            }
            else
            {
                ...
                //List<Models.CustomModels.MenuItem> listMenus = util.GetMenuByUser(user.ID_USER);

                //Session["MenuMaster"] = listMenus.ToList();
